...
public class YubikeyService {
    ...
    public PublicKeyCredentialCreationOptions beginRegistration(
    ...
    public RegistrationResult finishRegistration(
        ...
        PublicKeyCredentialCreationOptions request =
                (PublicKeyCredentialCreationOptions)
                        session.getAttribute("webauthn-registration");
        String username = (String)
                session.getAttribute("webauthn-username");
    ...
    public PublicKeyCredentialRequestOptions beginAuthentication(
            String username, HttpSession session) {
    ...
    public AssertionResult finishAuthentication(
        ...
        AssertionRequest request =
                (AssertionRequest) session.getAttribute("webauthn-authentication");
